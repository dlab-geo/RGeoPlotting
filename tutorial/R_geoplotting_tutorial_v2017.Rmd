...
```{r, eval=FALSE}
# pop density 
myclass <- classIntervals(census_blks$POP_DENS, 5, style = "quantile")
...
# rent
myclass <- classIntervals(census_blks$RENT, 5, style = "quantile")
...
census_geo <- spTransform(census_blks, CRS("+proj=longlat +ellps=WGS84"))
