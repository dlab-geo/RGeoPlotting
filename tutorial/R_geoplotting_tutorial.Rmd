...
- **long** is the X cooridnate value, typically longitude in decimal degrees as a numeric data type. Longitude values range from +-180 degrees east or west of prime meridian (running through Greenwich, England - just outside of London).
...
```{r, eval=FALSE}
proj4string(cafe_spdf) == proj4string(uc_buildings)  ## THIS SHOULD BE SP TRANSFORM! - check
```
