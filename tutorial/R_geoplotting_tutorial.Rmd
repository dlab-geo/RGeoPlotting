...
```{r, eval=FALSE}
coordinates(dat_sp)[row.names(dat_sp) == "strada",]
```
...
```{r, eval=FALSE}
plot(dat_sp)
points(coordinates(dat_sp)[row.names(dat_sp)=="strada", 1],
       coordinates(dat_sp)[row.names(dat_sp)=="strada", 2], col="red", pch=20)
```
